...
if __name__ == "__main__":
    ...
    dual_video = queued_multi_frame_grabber(_frame_grabber, (trigger_config,cam_config))
    dual_video = _frame_grabber(trigger_config,cam_config)            
    dual_video = apply_window(dual_video, (w1,w2))

    fdual_video = mkl_rfft2(dual_video, kisize = 128, kjsize = 128)
